    ...
    return createPortal(
        <div className="fixed inset-0 bg-background/60 backdrop-blur-sm flex items-center justify-center z-[100]">
            ...
            <div className="bg-background/20 border border-accent/30 border-solid backdrop-blur-[6px] py-8 px-6 xs:px-10 sm:px-16 rounded shadow-glass-inset text-center space-y-8">
                ...
                <p className="font-light">Would you like ambient noise?</p>
...
const Sound = () => {
    ...
    const handelFirstUserInteraction = () => {
        ...
        ["click", "keydown", "touchstart"].forEach((event) =>
            document.removeEventListener(event, handelFirstUserInteraction)
        )
    }
    ...
    useEffect(() => {
        ...
        if (consent && consentTime &&
            ...
            if (consent === "true") {
                ["click", "keydown", "touchstart"].forEach((event) =>
                    document.addEventListener(event, handelFirstUserInteraction)
                );
            }
        } else {
            setShowModal(true)
    ...
    return (
        <div className='fixed top-4 right-2.5 xs:right-4 z-50 group'>
            ...
            <audio ref={audioRef} loop>
                <source src={"/audio/zapsplat_science_fiction_outer_space_atmopshere_hum_drone_98562.mp3"} type='audio/mpeg' />
