        ...
        <>
            ...
            <div className="relative w-full h-screen flex flex-col items-center -translate-x-1/3 justify-center">
                <div className="absolute flex flex-col items-center top-1/2 sm:top-[50%] left-1/2 -translate-y-1/4 -translate-x-1/5">
                    <h1 className="font-bold text-6xl xs:text-7xl sm:text-8xl lg:text-9xl text-sky-300">Jack Sawyer</h1>
                    <p className="font-light text-foreground text-amber-200 text-center -translate-x-1/2 text-xl py-9">Meet the Mission Specialist.</p>
                </div>
            </div>
